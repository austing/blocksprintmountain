contract MountainFactory {
    ...
    function createContract (bytes32 name, uint multiplier, uint waitingWeeks, uint maxLoan) public returns (address) {
...
contract Mountain {
    ...
    // Address of factory
    MountainFactory public factory;
    ...
    function Mountain(bytes32 name, uint multiplier, uint waitingWeeks, uint maxLoan, address founder, address factory){
        name = name;
